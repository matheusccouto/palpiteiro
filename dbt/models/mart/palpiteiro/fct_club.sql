...
SELECT
    ...
    SUM(c.total_points) OVER (PARTITION BY c.club, c.home ORDER BY c.all_time_round ROWS BETWEEN 5 PRECEDING AND 1 PRECEDING) AS total_points_club_last_5,
    SUM(c.offensive_points) OVER (PARTITION BY c.club, c.home ORDER BY c.all_time_round ROWS BETWEEN 5 PRECEDING AND 1 PRECEDING) AS offensive_points_club_last_5,
    SUM(c.defensive_points) OVER (PARTITION BY c.club, c.home ORDER BY c.all_time_round ROWS BETWEEN 5 PRECEDING AND 1 PRECEDING) AS defensive_points_club_last_5,
    SUM(o.total_points) OVER (PARTITION BY c.club, c.home ORDER BY c.all_time_round ROWS BETWEEN 5 PRECEDING AND 1 PRECEDING) AS total_allowed_points_opponent_last_5,
    SUM(o.offensive_points) OVER (PARTITION BY c.club, c.home ORDER BY c.all_time_round ROWS BETWEEN 5 PRECEDING AND 1 PRECEDING) AS offensive_allowed_points_opponent_last_5,
    SUM(o.defensive_points) OVER (PARTITION BY c.club, c.home ORDER BY c.all_time_round ROWS BETWEEN 5 PRECEDING AND 1 PRECEDING) AS defensive_allowed_points_opponent_last_5,
    COALESCE(AVG(c.penalties) OVER (PARTITION BY c.club, c.home ORDER BY c.all_time_round ROWS BETWEEN 5 PRECEDING AND 1 PRECEDING), 0) AS penalties_club_last_5,
    COALESCE(AVG(o.penalties) OVER (PARTITION BY c.club, c.home ORDER BY c.all_time_round ROWS BETWEEN 5 PRECEDING AND 1 PRECEDING), 0) AS penalties_opponent_last_5,
    COALESCE(AVG(c.received_penalties) OVER (PARTITION BY c.club, c.home ORDER BY c.all_time_round ROWS BETWEEN 5 PRECEDING AND 1 PRECEDING), 0) AS received_penalties_club_last_5,
    COALESCE(AVG(o.received_penalties) OVER (PARTITION BY c.club, c.home ORDER BY c.all_time_round ROWS BETWEEN 5 PRECEDING AND 1 PRECEDING), 0) AS received_penalties_opponent_last_5,
